...
- `src/app/api/auth/forgot-password/route.ts`: password reset request route
- `src/app/api/auth/reset-password/route.ts`: password reset completion route
- `src/app/api/auth/resend-verification/route.ts`: resend verification email route
- `src/app/api/auth/verify-email/route.ts`: email verification route
- `src/app/api/health/route.ts`: Railway health check route
- `src/app/api/reminders/dispatch-pending/route.ts`: background reminder email dispatch route
...
- `src/lib/account-security.ts`: verification and password reset helpers
- `src/lib/env.ts`: shared environment and database path helpers
- `src/lib/email.ts`: shared outgoing mail helper
- `src/lib/validation.ts`: API input validation helpers
- `src/lib/auth.ts`: Auth.js configuration
- `src/lib/reminders.ts`: reminder email dispatch helpers
